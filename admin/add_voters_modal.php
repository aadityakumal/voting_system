	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			if (isset($_POST['save'])) {
				...
				mysqli_query($conn, "INSERT INTO candidate(position,firstname,lastname,year_level,gender,img)values('$position','$firstname','$lastname','$year_level','$gender','$location')") or die(mysqli_error($conn));
			}
