...
if (!$bool) {
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" name="position" placeholder="enter position"
								required="true" value="<?php echo $row['position']; ?>">
	...
	if (isset($_POST['update'])) {
		...
		$conn->query("UPDATE candidate SET position = '$position', firstname = '$firstname', lastname = '$lastname', gender = '$gender',img='$location' WHERE candidate_id = '$candidate_id'") or die(mysqli_error($conn));
