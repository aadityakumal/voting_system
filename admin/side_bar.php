<nav class="navbar navbar-default navbar-static-top" role="navigation"
    style="margin-bottom:0; background-color:cadetblue;">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="" style="color:white;">
            <i class="fa fa-home fa-large"> </i><span>ClickVote - An Online Voting Sytem</span></a>
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        $query = $conn->query("SELECT * from user where user_id ='$session_id'") or die(mysqli_error($conn));
        ...
        while ($row = $query->fetch_array()) {
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white">
                    <i class="fa fa-cog fa-spin fa-fw"></i>Welcome:
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="canvassing.php"><i class="fa fa-download fa-fw"></i> Final Result</a>
                </li>
